...
' Fixed ranges
'----------------------------
Public Const gstrModuleLookupRng As String = "B8:D753"                                    ' The range of cells in the REF sheet for modules
Public Const gintModuleLookupReturn As Integer = 4                                        ' The column number (not VLOOKUP) to return cohort size for modules
Public Const gstrCourseLookupRng As String = "B8:C196"                                    ' The range of cells in the REF sheet for courses
Public Const gintCourseLookupReturn As Integer = 4                                        ' The column number (not VLOOKUP) to return cohort size for courses
...
'----------------------------
Public Const gstrCourseSatisfactionHeadings As String = "Question Text,Not at all satisfied (1),Not very satisfied (2),Quite satisfied (3),Very satisfied (4),Valid responses,Mean,Median"
...
Public Const gstrCourseSkillsHeadings As String = "Question Text,Excellent (1),Good (2),Fair (3),Poor (4),Valid responses,Mean,Median"
